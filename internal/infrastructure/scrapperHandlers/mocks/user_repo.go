...
// TrackLink provides a mock function with given fields: userID, userLink
func (_m *UserRepo) TrackLink(userID int, userLink string) error {
	ret := _m.Called(userID, userLink)
...
//   - userID int
//   - userLink string
func (_e *UserRepo_Expecter) TrackLink(userID interface{}, userLink interface{}) *UserRepo_TrackLink_Call {
	return &UserRepo_TrackLink_Call{Call: _e.mock.On("TrackLink", userID, userLink)}
}

func (_c *UserRepo_TrackLink_Call) Run(run func(userID int, userLink string)) *UserRepo_TrackLink_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserRepo_TrackLink_Call) RunAndReturn(run func(int, string) error) *UserRepo_TrackLink_Call {
	_c.Call.Return(run)
	return _c
}
