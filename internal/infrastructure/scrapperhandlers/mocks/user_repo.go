...
func (_m *UserRepo) DeleteUser(user int64) error {
	ret := _m.Called(user)
...
//   - user int64
func (_e *UserRepo_Expecter) DeleteUser(user interface{}) *UserRepo_DeleteUser_Call {
	return &UserRepo_DeleteUser_Call{Call: _e.mock.On("DeleteUser", user)}
}

func (_c *UserRepo_DeleteUser_Call) Run(run func(user int64)) *UserRepo_DeleteUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64))
	})
	return _c
...
func (_c *UserRepo_DeleteUser_Call) RunAndReturn(run func(int64) error) *UserRepo_DeleteUser_Call {
	_c.Call.Return(run)
	return _c
}
...
// TrackLink provides a mock function with given fields: userID, link, update
func (_m *UserRepo) TrackLink(userID int64, link string, update time.Time) error {
	ret := _m.Called(userID, link, update)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(int64, string, time.Time) error); ok {
		r0 = rf(userID, link, update)
	} else {
		r0 = ret.Error(0)
	}
...
//   - link string
//   - update time.Time
func (_e *UserRepo_Expecter) TrackLink(userID interface{}, link interface{}, update interface{}) *UserRepo_TrackLink_Call {
	return &UserRepo_TrackLink_Call{Call: _e.mock.On("TrackLink", userID, link, update)}
}

func (_c *UserRepo_TrackLink_Call) Run(run func(userID int64, link string, update time.Time)) *UserRepo_TrackLink_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64), args[1].(string), args[2].(time.Time))
	})
	return _c
}
...
func (_c *UserRepo_TrackLink_Call) RunAndReturn(run func(int64, string, time.Time) error) *UserRepo_TrackLink_Call {
	_c.Call.Return(run)
	return _c
}
